...
const inputCls =
  "w-full rounded-lg bg-panel2 nm-inset px-3.5 py-2.5 text-sm text-ink outline-none focus:ring-2 focus:ring-accent/45";
    ...
    <div className="relative grid min-h-[100dvh] place-items-center overflow-hidden bg-bg px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-panel nm-raised p-7">
        <div className="mb-6 flex items-center gap-3">
          <div className="grid h-11 w-11 place-items-center rounded-lg bg-accent font-mono text-lg font-bold text-onAccent nm-raised-sm">C</div>
          <div>
            <p className="font-head text-lg font-bold leading-tight text-ink">Consmat Hub</p>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button type="submit" disabled={busy}
            className="w-full rounded-lg bg-accent py-2.5 text-sm font-semibold text-onAccent nm-press hover:bg-accentHover disabled:opacity-40">
