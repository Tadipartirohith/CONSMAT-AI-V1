...
Runs before Alembic. Connects to the maintenance `postgres` database on the same server and issues
CREATE DATABASE for the target. Safe to run repeatedly. Usage: python -m app.ensure_db
"""
